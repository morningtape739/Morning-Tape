...
(function () {
  ...
  const ASSETS = {
    ...
    'XRP':   { kind: 'crypto', cc: 'XRP',  label: 'XRP' },
    'ADA':   { kind: 'crypto', cc: 'ADA',  label: 'Cardano' },
  };
  ...
  async function fetchCrypto(symbol, days) {
    ...
    const cgIds = { BTC: 'bitcoin', ETH: 'ethereum', SOL: 'solana', LINK: 'chainlink', XRP: 'ripple', ADA: 'cardano' };
